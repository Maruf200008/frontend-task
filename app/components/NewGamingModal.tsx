...
export default function NewGamingModal({ modalData }) {
  ...
  return (
    <div className="backdrop-blur-md  z-50 w-full md:w-[450px]   bg-[#090909]/70  border border-[#343434]  rounded-2xl p-5">
      <div>
        <div className="  md:w-[300px] space-y-5 ">
          ...
          <div className=" md:w-[400px] text-sm ">
            <SyntaxHighlighter
              language="javascript"
